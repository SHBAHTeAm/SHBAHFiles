...
if not DevAbd:get(SHBAH..'Abd:Lock:Reply'..msg.chat_id_) then
...
elseif AbdConstructor(msg.sender_user_id_, msg.chat_id_) then
...
Dev_Abd(msg.chat_id_, msg.id_, 1,rd, 1, 'html')
end
if text == 'دي' or text == 'ديي' or text == 'دي بابه' then 
SHBAHTeAm =  "آخلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪"
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md') 
return false
end
if text == 'السلام عليكم' or text == 'سلام عليكم' then 
SHBAHTeAm =  "ياھَہّلْاا ۅﻋ̝̚لْيڪْم الْﺳ̭͠ لْام 𖠙 🤤♥️"
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md') 
return false
end
if text == '😭💔' or text == '😭😭' or text == '😭😭😭' or text == '😿💔' or text == '😭😭😭' or text == '😭😭😭😭' then 
SHBAHTeAm =  "مآآعٍآشُ آلُِي يزعٍلُِڪڪ 𖠙 😏♥️"
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md') 
return false
end
if text == '🌚💔' or text == '💔🌚' or text == '🚶‍♂💔' or text == '💔' or text == '😔💔' or text == '🚶‍♀💔' or text == '😭' then 
SHBAHTeAm =  "شبّيي اﻟ̣̣פﻟ̣̣و 𖠙 😿💔"
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md') 
return false
end
if text == 'باي' or text == 'بااي' or text == 'اروح' or text == 'اروح احسن' or text == 'اولي احسن' or text == 'راح اروح' or text == 'باي انام' then 
SHBAHTeAm =  "أُرٌجُعُ عٍيدِهآآ مٍوو تنِْسةه 𖠙 🤤♥️"
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md') 
return false
end
if text == 'هلو' or text == 'هلاو' or text == 'هلا' or text == 'هلاوو' or text == 'هيلاو' or text == 'هيلاوو' or text == 'هلاا' then 
local SHBAHTeAm = {"اࠗط็لق֯ق֯ هٞللاࠗ୨و 𖠙 🤤♥️" ,"هۂَلاا نۨہٰورتت يعمۘري 𖠙 🤤♥️" } 
DevAbd2 = math.random(#SHBAHTeAm) 
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm[DevAbd2] , 1, 'md') 
return false
end
if text == 'سورس' or text == 'السورس' or text == 'سورس' or text == 'السورس' or text == 'سورس منو' or text == 'سورسك' or text == 'سورس البوت' then 
local SHBAHTeAm = {"سورس خالتك" } 
DevAbd2 = math.random(#SHBAHTeAm) 
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm[DevAbd2] , 1, 'md') 
return false
end
...
local SHBAHTeAm = {"ماﺷ͠ يةھَہّ يﻋ̝̚مريي ۅاﻧﺗ̲ت 𖠙 🤤♥️" ,"الحۡمۘدللهۂَ ٰوانۨہتت 𖠙 🤤♥️","تمۘامۘ عمۘري ٰوانۨہتت 𖠙 🤤♥️"} 
DevAbd2 = math.random(#SHBAHTeAm) 
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm[DevAbd2] , 1, 'md') 
return false
end
if text == 'وينك' or text == 'وينج' then
SHBAHTeAm =  "مْوٌجہوٌدِ يہمْگُ يحلوُ 𖠙 😉♥️"
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md') 
return false
end
if text == 'بوت عواي' or text == 'بوت زربه' or text == 'البوت عاوي' or text == 'البوت زربه' then
SHBAHTeAm =  "اطردكك تجرب ؟ ، 😕🔪"
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md') 
return false
end
if text == 'نايمين' or text == 'ميتين' then
SHBAHTeAm =  "طُآمسين ووعٍيوونڪ 𖠙 😪🖤ۦ"
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md') 
return false
end
if text == 'هلوباي' or text == 'هلو باي' then  
SHBAHTeAm =  "شحۡسۜيت مۘنۨہ هيجۚ ּكتبت ؟ 🌝♥️"
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md') 
return false
end
if text == 'اكلك' or text == 'اكلج' or text == 'اكلكم' then 
SHBAHTeAm =  "ڪوولُِ مآڪوولُِ لُِآحٍدِ 𖠙 😉♥️"
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md')
return false
end
if text == 'فرخ' then
SHBAHTeAm =  "ٰوينۨہهۂَ خۡل احۡصرهۂَ 𖠙 😹♥️" 
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md') 
return false
end
...
SHBAHTeAm =  "لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪" 
Dev_Abd(msg.chat_id_, msg.id_, 1, SHBAHTeAm, 1, 'md')
return false
end
end
...
if not DevAbd:get(SHBAH..'Abd:Lock:Reply'..msg.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد مفعله ', 1, 'md')
else
Dev_Abd(msg.chat_id_, msg.id_, 1, '⌁︙تم تفعيل ردود البوت', 1, 'md')
DevAbd:del(SHBAH..'Abd:Lock:Reply'..msg.chat_id_)
end end
if text == 'تعطيل ردود البوت' or text == 'تعطيل الردود' then
if DevAbd:get(SHBAH..'Abd:Lock:Reply'..msg.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد معطله ', 1, 'md')
else
DevAbd:set(SHBAH..'Abd:Lock:Reply'..msg.chat_id_,true)
Dev_Abd(msg.chat_id_, msg.id_, 1, '⌁︙تم تعطيل ردود البوت', 1, 'md')
end end
end
end
